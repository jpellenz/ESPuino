...
#define __ESPUINO_SETTINGS_H__
    ...
    */
    ...
    #define BUTTON_3_SHORT    CMD_PLAYPAUSE // CMD_MEASUREBATTERY
    ...
    #define BUTTON_MULTI_01   CMD_MEASUREBATTERY // TOGGLE_WIFI_STATUS
    #define BUTTON_MULTI_02   CMD_NOTHING // ENABLE_FTP_SERVER
    #define BUTTON_MULTI_03   TOGGLE_WIFI_STATUS // CMD_NOTHING
    #define BUTTON_MULTI_04   CMD_NOTHING
    #define BUTTON_MULTI_05   CMD_NOTHING
    #define BUTTON_MULTI_12   CMD_NOTHING
    #define BUTTON_MULTI_13   ENABLE_FTP_SERVER // CMD_NOTHING
